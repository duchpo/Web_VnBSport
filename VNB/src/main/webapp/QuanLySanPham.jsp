    ...
    <div class="card">
        <div class="card-header py-3 row">
            <div class="col-sm-12 text-center">
                <h5 class="mb-0" style="font-size: 60px;">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-center mb-3">
                <button type="button" class="btn btn-success mr-2" data-toggle="modal" data-target="#addEmployeeModal">Thêm sản phẩm</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="loadProduct?pid=${o.id}">
                                        <button type="button" ><i class="material-icons" data-toggle="tooltip" title="Edit">build</i></button>
                                    </a>
                                    <a href="delete?pid=${o.id}">
                                        <button type="button" ><i class="material-icons" data-toggle="tooltip" title="Delete" style="color: black;">delete</i></button>
                                    </a>
                                </td>
                            </tr>
                        </c:forEach>
            ...
            <!-- Pagination Section: Add this part to match the layout -->
            <div class="clearfix">
                <ul class="pagination">
                    <c:if test="${tag != 1}">
