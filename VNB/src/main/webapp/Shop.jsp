...
<c:forEach items="${listP}" var="o">
  ...
  <script>
    ...
    function searchByPriceMinToMax(){
        ...
        $.ajax({
            url: "/VNB/searchAjaxPriceMinToMax",
            type: "get", //send it through get method
            data: {
                priceMin: numMin,
                priceMax: numMax
    ...
    function searchByPriceUnder100(){
        $.ajax({
            url: "/VNB/searchAjaxPriceUnder100Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPrice100To200(){
        $.ajax({
            url: "/VNB/searchAjaxPrice100To200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPriceAbove200(){
        $.ajax({
            url: "/VNB/searchAjaxPriceAbove200Shop",
            type: "get", //send it through get method
            data: {
