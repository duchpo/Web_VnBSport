    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-center mb-3">
                <button type="button" class="btn btn-success mr-2" data-toggle="modal" data-target="#addEmployeeModal">Thêm nhà cung cấp</button>
...
<!-- End Section: Quan Ly nha cung cap -->
